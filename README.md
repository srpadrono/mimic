...
[![Tests](https://img.shields.io/badge/tests-1305%20passing-brightgreen)](#testing)
...
1305 tests, counted as `@Test` and `func test` declarations — a parameterized case runs many times
...
| macOS UI (XCUITest) | 171 | macOS, interactive session |
...
`WorkspaceFeatureTests` 115, `MimicTests` 176, `JourneyFeatureTests` 14, `ImportFeatureTests` 15,
