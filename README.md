...
[![Tests](https://img.shields.io/badge/tests-1327%20passing-brightgreen)](#testing)
...
1327 tests, counted as `@Test` and `func test` declarations — a parameterized case runs many times
...
| macOS UI (XCUITest) | 181 | macOS, interactive session |
