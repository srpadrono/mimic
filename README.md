...
[![Tests](https://img.shields.io/badge/tests-1326%20passing-brightgreen)](#testing)
...
1326 tests, counted as `@Test` and `func test` declarations — a parameterized case runs many times
...
| macOS UI (XCUITest) | 180 | macOS, interactive session |
