...
[![Tests](https://img.shields.io/badge/tests-1301%20passing-brightgreen)](#testing)
...
1301 tests, counted as `@Test` and `func test` declarations — a parameterized case runs many times
...
| macOS UI (XCUITest) | 169 | macOS, interactive session |
