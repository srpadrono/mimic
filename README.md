...
[![Tests](https://img.shields.io/badge/tests-1304%20passing-brightgreen)](#testing)
...
1304 tests, counted as `@Test` and `func test` declarations — a parameterized case runs many times
