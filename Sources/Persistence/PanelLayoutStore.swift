...
public final class PanelLayoutStore: @unchecked Sendable {
    ...
    public enum Bounds {
        /// The request log's floor leaves room for its controls, column headers and two rows. At
        /// 100pt the rows existed in accessibility but the table viewport was only 15pt tall.
        /// Handed to `NSSplitViewItem.minimumThickness`, so a further drag collapses the pane.
        public static let minimumRequestLogHeight: CGFloat = 160

        /// What the centre pane keeps no matter how far the request log is dragged. Enough for the
        /// editor's header and the first journey step; longer editors scroll inside their pane.
        ///
        ...
        public static let minimumCentreHeight: CGFloat = 270
