...
let dependencyTargets = [
    ...
    "CNIOBoringSSL", "CNIOBoringSSLShims", "CNIODarwin", "CNIOExtrasZlib", "CNIOLLHTTP", "CNIOLinux",
    ...
    "NIOFileSystem", "NIOFoundationCompat", "NIOHPACK", "NIOHTTP1", "NIOHTTP2", "NIOHTTPCompression",
